...
def get_latest_precommit_hook() -> dict[str, Sequence[Collection[str]]]:
    """
    ...
    if not latest_release:
        raise PackitException(
            "Something went wrong trying to fetch latest precommit"
            " release. Please check your internet connection.",
        )
    precommit_config = PRECOMMIT_CONFIG_TEMPLATE
